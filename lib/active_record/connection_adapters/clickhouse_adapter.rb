...
require "active_record/connection_adapters/clickhouse/migration"
...
module ActiveRecord
  module ConnectionHandling # :nodoc:
    ...
    def clickhouse_connection(config)
      ...
      raise ArgumentError.new("No database specified. Missing argument: database.") unless config.key?(:database)
    ...
    class ClickhouseAdapter < AbstractAdapter
      ...
      class << self
        ...
        def initialize_type_map(m) # :nodoc:
          ...
          register_class_with_precision m, /datetime/i, Clickhouse::OID::DateTime

          register_class_with_limit m, /Int8/, Type::Integer
          register_class_with_limit m, /Int16/, Type::Integer
          register_class_with_limit m, /Int32/, Type::Integer
          register_class_with_limit m, /Int64/, Type::Integer
          register_class_with_limit m, /Int128/, Type::Integer
          register_class_with_limit m, /Int256/, Type::Integer
          ...
          register_class_with_limit m, /UInt64/, Type::UnsignedInteger
          register_class_with_limit m, /UInt256/, Type::UnsignedInteger
      ...
      def schema_migration
        Clickhouse::SchemaMigration.new(self)
      end

      def internal_metadata
        Clickhouse::InternalMetadata.new(self)
      end
      ...
      def show_create_table(table)
        @show_create_table ||= {}
        @show_create_table[table] ||= do_system_execute("SHOW CREATE TABLE `#{table}`")["data"].try(:first).try(:first).gsub(/[\n\s]+/m, " ")
      end
      ...
      def create_table(table_name, **options, &block)
        ...
        return unless options[:with_distributed]
      ...
      def replica_path(table)
        "/clickhouse/tables/#{cluster}/{uuid}/#{@connection_config[:database]}.#{table}"
      end
